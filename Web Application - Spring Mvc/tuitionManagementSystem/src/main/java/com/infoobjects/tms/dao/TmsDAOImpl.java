...
public class TmsDAOImpl {
    ...
    public void insert(Map dataMap, DTO reference) throws  Exception {
    ...
    public void delete(Map dataMap, DTO reference) throws  Exception {
    ...
    public List<Map<String, Object>> find(Map dataMap, DTO reference) throws  Exception {
    ...
    public void update(Map dataMap, DTO reference, String idName) throws  Exception {
        int i = 1;
    ...
    public List<Map<String, Object>> findAll(Map dataMap, DTO reference) throws  Exception {
        ResultSet resultSet = null;
    ...
    public List<Map<String, Object>> executeQueryWithResultSet(String sqlQuery, List values) throws  Exception {
        ResultSet resultSet = null;
        PreparedStatement preparedStatement = null;
        try {
            preparedStatement = SingletonConnection.getInstance().getConnection().prepareStatement(sqlQuery.toString());
